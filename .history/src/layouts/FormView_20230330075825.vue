...
<template>
  <form action="">
    ...
    <button type="submit" v-show="logInSetup" @click="goTanksPage()">
      Register
    </button>
    <button type="submit" v-show="!logInSetup" @click="goHome()">Login</button>
    <p class="go-to-login" v-show="logInSetup">
      Already signed up
      <router-link to="/login">? Go to login</router-link>
    </p>
    <p class="go-tologin" v-show="!logInSetup">
      <router-link to="/singup">Don’t have an account? Sign up</router-link>
    </p>
  </form>
</template>
